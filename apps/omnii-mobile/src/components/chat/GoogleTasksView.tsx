      ...
      >
        <View className="flex-row items-center justify-between">
          <View>
            ...
            >
              {overview.totalTasks} tasks • {overview.totalCompleted} completed
            </Text>
          </View>
    ...
    >
      ...
      {!isMobileFullWidth && (
        ...
        >
          ...
          >
            {list.taskCount} tasks • {list.completedCount} completed
          </Text>
        </View>
      )}
        ...
        <View className="flex-1">
          ...
          >
            ...
            >
              {task.due
                ? isOverdue
                  ? `⚠️ Overdue: ${new Date(task.due).toLocaleDateString()}`
