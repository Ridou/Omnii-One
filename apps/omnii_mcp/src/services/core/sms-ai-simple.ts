  ...
  async processMessage(
    ...
    try {
      ...
      return {
        ...result,
        brainMemoryUsed,
        memoryStrength: brainMemoryContext ? (brainMemoryContext as BrainMemoryContext).consolidation_metadata?.memory_strength : undefined,
        relatedConversations: brainMemoryContext ? ((brainMemoryContext as BrainMemoryContext).working_memory?.recent_messages?.length ?? 0) : 0,
