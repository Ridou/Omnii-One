...
Note: This migration will be applied manually via Supabase dashboard or CLI since we don't have automated migration runner. Document this in verification step.
  </action>
  <verify>
